...
class benchmarking():
    ...
    def get_prescriptive_prompt(self, schema, question):
        return """## Task:
...
["TABLE_NAME_1", "TABLE_NAME_2"]""";
    ...
    def generate(self, database_name, question):
        ...
        try:
            ...
            prompt = self.get_prescriptive_prompt(schema, question)
...
if __name__ == "__main__":
    ...
    input_file = "/home/shivangi/data-to-story/question_generation_benchmarking/question_jsons/prescriptive_questions.json"
    output_file = "./question_generation_benchmarking/question_jsons/prescriptive_questions_with_tableused.json"
    ...
    # with open("/home/shivangi/data-to-story/question_generation_benchmarking/question_jsons/prescriptive_questions.json", "r") as file:
    #     loaded_dict = json.load(file)
