...
logging.basicConfig(filename='./logger/qgen_logger_prescriptive.log', level=logging.INFO, filemode='a', format='%(asctime)s - %(levelname)s - %(message)s')
...
Return a single JSON array named `questions`, not multiple arrays.""";
    ...
    def generate(self, database_name):
        ...
        try:
            ...
            prompt = self.get_prescriptive_prompt(schema)
...
if __name__ == "__main__":
    ...
    file_path = "./question_generation_benchmarking/question_jsons/prescriptive_questions.json"
